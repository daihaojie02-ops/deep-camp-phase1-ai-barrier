...
3. **社区活跃、上手案例多。** 54.5K⭐ + MIT 协议 + 53 位贡献者的持续维护，意味着遇到问题时能搜到解决方案的概率更高。
4. **"先用起来"比"选完美的"重要 10 倍。** 我自评 Multi-Agent 1/5，需要的不是选对框架，而是尽快动手把 1 分变成 3 分。

### 🥈 如果场景变了：Microsoft Agent Framework

如果我需要持久化状态、复杂分支、或人机协作的能力，MAF 的 DurableTask + Graph Workflows 是更好的选择。目前对初学阶段的我而言太重，但值得关注——微软在 2026 年对 MAF 的投入力度很大。

### 🥉 参考但不选：MetaGPT

我会学习它"SOP 固化为流程"的设计思路。它的场景太窄，Token 成本太高。
